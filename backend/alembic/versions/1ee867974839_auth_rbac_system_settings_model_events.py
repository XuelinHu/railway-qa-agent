...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["actor_id"],
            ["users.id"],
            name=op.f("fk_model_events_actor_id_users"),
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_model_events")),
    )
    op.create_index(
        op.f("ix_model_events_created_at"), "model_events", ["created_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["handled_by"],
            ["users.id"],
            name=op.f("fk_password_reset_requests_handled_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
    ...
    op.create_index(
        op.f("ix_password_reset_requests_created_at"),
        "password_reset_requests",
        ["created_at"],
        unique=False,
    )
    ...
    op.add_column(
        "users", sa.Column("login_count", sa.Integer(), server_default=sa.text("0"), nullable=False)
    )
    op.add_column(
        "users",
        sa.Column(
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_password_reset_requests_token_hash"), table_name="password_reset_requests"
    )
    op.drop_index(op.f("ix_password_reset_requests_status"), table_name="password_reset_requests")
    op.drop_index(
        op.f("ix_password_reset_requests_created_at"), table_name="password_reset_requests"
    )
